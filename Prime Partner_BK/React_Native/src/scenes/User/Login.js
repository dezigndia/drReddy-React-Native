...
import { Text, AsyncStorage, View, StyleSheet, Dimensions, SafeAreaView, ImageBackground, Image, TextInput, TouchableOpacity, Modal, ActivityIndicator, Alert, BackHandler } from 'react-native'
            ...
            .then(res => {
                ...
                parseString(res, function (err, result) {
                    if(result.Value.AccountID[0]!='NA'){
                        ...
                        if(result.Value.ChemistCardNo[0]==='Mobile number does not exist'){
                            Alert.alert(
                                'Prime Partner',
                                result.Value.ChemistCardNo[0],
                                [
                                  {text: 'OK', onPress: () => _that.props.navigation.navigate("SignUp")},
                                ],
                                {cancelable: false},
                              );
                        }else{
                ...
                >
                       ...
                       <View style={styles.formView}>
                            <Form style={styles.form}>
                                ...
                                <Item 
                                style={[styles.itemForgotPassword]}>
                                    <TouchableOpacity
                       ...
                       <View style={styles.enrollView}>
                            ...
                            >
                                <Text style={styles.enrollText}>Not Prime Partner? Enroll Now.</Text>
                            </TouchableOpacity>
                       </View>
                </ImageBackground>
                    <Modal
