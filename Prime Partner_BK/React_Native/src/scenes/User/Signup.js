        ...
        return (
            ...
            <View style={styles.container}>
                ...
                <View style={styles.headerTextView}>
                    <Text style={styles.headerText}> If you want to join the program fill below details we will contact you soon. </Text>
                </View>
                <View>
                        <Form style={{ padding: 20 }}>
                            ...
                            >
                                <TextInput
                                    ...
                                    placeholderTextColor='#522e90'
                                    onChangeText={(primaryMobile) => this.setState({ primaryMobile })}
                                    // keyboardType='number-pad'
                                />
                            </Item>
                            <Item inlineLabel
                            ...
                            >
                                <TextInput
                                    ...
                                    placeholderTextColor='#522e90'
                                    onChangeText={(medicalStoreAddress) => this.setState({ medicalStoreAddress })}
                                    // keyboardType='number-pad'
                                />
                            </Item>
                            <Item inlineLabel
                            ...
                            >
                                <TouchableOpacity
                                        style={styles.Submit}
                                        onPress={()=>this.setState({loading:true},()=>{this._registeredUser();this.setModalVisible(true);})}
                                    >
